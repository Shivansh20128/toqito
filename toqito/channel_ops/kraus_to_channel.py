"""Given a collection of Kraus operators, converts them into the corresponding quantum channel."""
...
def kraus_to_channel(kraus_list: list[tuple[np.ndarray, np.ndarray]]) -> np.ndarray:
